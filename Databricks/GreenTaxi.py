...
WriteGreenTaxiObj = WriteGreenTaxi(
    ...
    sourcePath = f'/mnt/sadb01dev/commonfiles-{dbutils.widgets.get("env")}/Raw/GreenTaxiTripData_201812.csv',
    targetPath = f'/mnt/sadb01dev/commonfiles-{dbutils.widgets.get("env")}/Processed/Facts/GreenTaxi'
)
