...
WriteYellowTaxiObj = WriteYellowTaxi(
    ...
    options = {"header":"true"},
    sourcePath = f'/mnt/sadb01dev/commonfiles-{dbutils.widgets.get("env")}/Raw/YellowTaxiTripData_201812.csv',
    targetPath = f'/mnt/sadb01dev/commonfiles-{dbutils.widgets.get("env")}/Processed/Facts/YellowTaxi'
)
